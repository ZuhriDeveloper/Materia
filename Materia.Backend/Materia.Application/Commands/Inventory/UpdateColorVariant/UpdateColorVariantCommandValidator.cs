...
public class UpdateColorVariantCommandValidator : AbstractValidator<UpdateColorVariantCommand>
{
    public UpdateColorVariantCommandValidator(IProductQueryRepository productQueryRepository)
    {
